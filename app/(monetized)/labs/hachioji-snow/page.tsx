    ...
    <article className="space-y-10 leading-relaxed">
      <header className="overflow-hidden rounded-[2rem] bg-slate-900 text-white">
        <div className="grid items-center lg:grid-cols-2">
          ...
          <figure><Image src="/images/hachioji-snow/hero-illustration.webp" width={1536} height={1024} alt="雪の駅前広場と中継カメラを描いたイラスト" priority className="w-full" /><figcaption className="px-5 py-3 text-xs text-slate-300">導入用のAI生成イラスト。実際の災害写真や特定日時の再現ではありません。</figcaption></figure>
        </div>
      </header>
