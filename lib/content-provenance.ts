...
export const toukeiProblemBatch2Provenance: ContentProvenance = {
  ...
  revisions: [{
    date: "2026-09-04",
    kind: "初版",
    summary: "第2バッチ5問の受領原稿をCodexが修正・独立検算・実装し、運営者が公開内容を承認しました。",
  }],
};
...
export const toukeiProblemBatch3Provenance: ContentProvenance = {
  ...
  humanReview:
    "運営者が題材と実装方針を指定し、最終公開内容を承認しました。専門家による第三者査読ではありません。",
  evidenceLinks: [
    {
      title: "統計検定2級の公式出題範囲",
      url: "https://www.toukei-kentei.jp/grade/grade2/",
  ...
  revisions: [{
    date: "2026-09-05",
    kind: "初版",
    summary: "第3バッチ5問の受領原稿をCodexが修正・独立検算・実装し、運営者が公開内容を承認しました。",
  }],
};
...
export const toukeiProblemBatch4Provenance: ContentProvenance = {
  ...
  humanReview:
    "運営者が公式テキスト・問題集に基づく未出題5問の構成案を承認しました。最終公開内容の確認と公開可否の判断は未実施です。専門家による第三者査読ではありません。",
  evidenceLinks: [
    {
      title: "統計検定2級の公式出題範囲",
      url: "https://www.toukei-kentei.jp/grade/grade2/",
  ...
  revisions: [{
    date: "2026-09-05",
    kind: "初版",
    summary: "第4バッチ5問をAntigravityが独自設計・実装・SciPy検算し、Codexレビュー指摘（出典URL・解説厳密化）を反映してローカル検証を実施しました。最終公開内容は承認待ちです。",
  }],
};
